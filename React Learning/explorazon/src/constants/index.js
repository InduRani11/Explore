export const productsData = [
    {
        ...
        review_title:
            "Helpful for my mother,Do Not Buy this product,Very cute solid and comfortable 👌,Very efficient,Not operational product dispatched Also u cant cancel the order, received replacement working ok,Bottom bowl is low quality plastic & not as per in the picture,Overall good product,Good material product.",
        review_content:
    ...
    },
    {
        ...
        rating_count: 681,
        about_product:
            "【Bluetooth Calling Watch】- Tokdis MX-1 Pro enables you to make and receive calls directly from your watch via the built-in speaker and microphone. This smartwatch features a dial pad, option to access recent calls & manually sync your phone’s contacts.|【How to activate Bluetooth Calling】- To enable Bluetooth Calling Function, first connect it to the Fitpro app. Once connected, manually go to the phone's Bluetooth settings and pair this smartwatch. Upon pairing, you will get a notification.|【1.69 inch HD Full Touch】 - Large Display of 1.69 Inches Size 【Full Metal Body】 - This Watch features Sleek & Fashionable Metal Body The one-click control mode and honey comb menu helps you quickly navigate|【Music Experience On The Go】 - Equipped with an inbuilt speaker, this smartwatch lets you play your favourite tracks on the Watch without having to take out your phone.|【Multiple Watch Faces & Smart Controls】 - The Smartwatch has unlimited Watch Faces on cloud. It has Smart controls like Weather Forecast, Alarm and many more. Get a 6 Months assured warranty from Tokdis in case of any Manufacturing Defect (Just Contact our Customer Care).",
        user_id:
    ...
    },
    {
        ...
        rating_count: "67,950",
        about_product:
            "[10-day battery]: With a battery backup of 10 days, just concentrate on your game without stopping.|[Noise Health Suite]: Automatically monitor your blood oxygen (Spo2 levels), real-time heart rate, and provide comprehensive analysis of your sleep quality (deep sleep,light sleep and wake up time) on this smart watch.|[Personalise your look]: Choose from 60+ cloud-based watch faces or customise them as per your preference.|[1.4’’ Full Touch HD display]: Get the perfect viewing experience on the 1.4’’ display with 240*240 pixels.|8 sports modes: Choose from 8 sports modes and give it your best.",
        user_id:
        ...
        user_name:
            "Ankita Dwivedi,Malathi Alunkar,Shubham♎,Oishi Basak,Dhananjay Sevalkar,User,Manohar salave,Kareti Naveen",
        review_id:
    ...
    },
    {
        ...
        review_title:
            "nice product,Great watch,Ok ok,Nice 👍,Thik thak,Avarage,Smart watch,They can improve more",
        review_content:
            "I really like this product. Gifted to my sister, and she likes it,Great ⌚,Good product,Nice 👍,Thik hai,In this price range it's ok product,Color so nice..I loved it,Need some more features:(",
        img_link:
    ...
    },
    {
        ...
        review_content:
            "Stand is good. But the light is not that bright. In photos it Feels bright but irl not that use of the light.Also setting up the light and stand takes bit of effort.Quality of stand and parts is average .I bought it for Rs 800 but I won’t recommend u guys to pay even a rupee more than Rs 400 for it.,Good product,I liked it as it is easy to use and helpful in clicking better pictures,Easy to handle..worthy..,Great product for beginners,good,Light quality is really good at this price segment,I really liked it's portability as we can take this to another place easily,",
        img_link:
    ...
    },
    {
        ...
        review_content:
            "कुछ खाश नही है मगर ठीक है कोई ज्यादा खराब भी नही है,This protect is good but very too much  noiceJuicer it too good,Purchased few days ago. The plastic quality is not as expected. I think It is not for long lasting purpose. Operating functions are good to use.,Item is good but in my case motor started sparking with in 3 months, still replacement of motor is pending from maharaja,Not bad,,Yes the product is very useful and serve the purpose for what it is.,Valuable one  cost effective and amazing delivery in one day.",
        img_link:
